...
public class Basechar {
	...
	System.out.println ("Enter a to attack,e to eat a sandwich, and d to drink a potion");
	Scanner scanner= new Scanner(System.in);
	String Action = scanner.nextLine();
	if (Action.equals("a")){
	...
	other.health= other.health - (this.getAttack()+ (int)Math.ceil(Math.random()*20) - 10 - other.getDefense());
